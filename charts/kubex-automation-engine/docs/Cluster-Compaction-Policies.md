...
`ClusterCompactionPolicy` defines which workloads participate in active bin-packing and how Kubex binds them to the dedicated compaction scheduler and per-policy descheduler deployments.
