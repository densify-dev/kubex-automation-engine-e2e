...
The chart's pre-delete hook removes finalizers from Helm-managed rightsizing resources created by this release so `helm uninstall` can complete while the controller is shutting down.
